...
\begin{frame}
	...
	\begin{minipage}{0.48\tw}
		...
		\only<4>{\centering \includegraphics[width = 0.7\tw]{figures/HFD_01_sensor.JPG}}
	\end{minipage}
\end{frame}
...
\begin{frame}
  ...
  Plant vulnerability to embolism can be predicted by structural, functional and wood anatomical traits:
  \begin{itemize}
